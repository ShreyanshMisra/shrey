  ...
  return (
    <section>
      ...
      <ul className="flex flex-col md:flex-row mt-8 space-x-0 md:space-x-4 space-y-2 md:space-y-0 font-sm text-neutral-600 dark:text-neutral-300">
        ...
        <TextLink text="Fire Safety" link="./certificates/firesafety.pdf" />
        <TextLink
      ...
      <p className="leading-loose mt-8">
        <span className="font-bold">Relevant Coursework</span>: Programming with
        Data Structures, Computer Systems, Intro to Computation (Discrete
        Mathematics), Multivariate Calculus, Linear Algebra, Intro to
        Kinesiology.
      </p>
    </section>
  );
